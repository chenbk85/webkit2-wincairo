...
xcopy /y /d "%ProjectDir%..\platform\%1\*.h" "%CONFIGURATIONBUILDDIR%\include\WebCore"
...
xcopy /y /d "%ProjectDir%..\platform\graphics\texmap\coordinated\*.h" "%CONFIGURATIONBUILDDIR%\include\WebCore"
xcopy /y /d "%ProjectDir%..\platform\graphics\surfaces\*.h" "%CONFIGURATIONBUILDDIR%\include\WebCore"
